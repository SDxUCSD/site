...
export default function PixelatedButton({text, href}: {text:string, href:string}) {
  ...
  const content = <> {/* Inverted background (black) with white text - this is the target state */}
